...
<div class="shadow-lg p-3 mb-5 mt-5 bg-white rounded">
    ...
    <table class="table table-sm table-bordered">
        <tr>
            ...
            <th>
                <a
                    href="<?php echo site_url() . "user-types/all-user-types/user_type_name/" . $order_method . "/" . $page; ?>">UserType
                    Name
                </a>
            </th>
            <th>
                <a
                    href="<?php echo site_url() . "user-types/all-user-types/user_type_status/" . $order_method . "/" . $page; ?>">Status
                </a>
            </th>
            <th>Actions
            </th>
...
if ($all_user_types->num_rows() > 0) 
{
        ...
        echo "<button class= 'badge badge-success' data-toggle='modal'>activated  </button>";
            ...
            <td>
                <a href="#modalLoginAvatar<?php echo $id ?>" class="btn btn-primary" data-toggle="modal"
                    data-target="#modalLoginAvatar<?php echo $id ?>">
                    <i class="fas fa-eye">
                    </i>
                </a>
                <button class="btn btn-warning">
                    <?php echo anchor("user-types/edit-user-type/" . $id, '<i class="fas fa-edit"></i>'); ?>
                </button>
                <?php
    if ($check == 0) 
    {
    ...
    ?>
                <button class="btn btn-danger" data-toggle='modal'
                    onclick="return confirm('are you sure to delete user type?')">
                    <?php echo anchor("user-types/delete-user-type/" . $id, "<i class='fas fa-trash-alt'></i>"); ?>
                </button>
            </td>
