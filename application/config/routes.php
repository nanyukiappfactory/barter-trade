...
$route['users/all-users']='admin/users/view_user';
$route['users/all-users/(:any)/(:any)/(:num)'] ='admin/users/view_user/$1/$2/$3';
$route['users/all-users/(:any)/(:any)'] ='admin/users/view_user/$1/$2';
$route['users/all-users/(:num)'] ='admin/users/view_user/$1';
